...
if __name__ == "__main__":
    fit_filename = r"C:\DTWorkSpace\AntiGravityProject\ZEEPLOG\Zepp20260419222058.fit"
    csv_filename = r"C:\DTWorkSpace\AntiGravityProject\ZEEPLOG\Zepp20260419222058.csv"
